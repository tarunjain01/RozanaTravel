...
<script type="text/javascript">var reportbus=1;</script>
		...
		<section id="content">
			...
			<div id="reportbuslocate">
				<form>
					...
					<input type="button" onclick="var b=validatebussubdata();if(b){showAddress(document.getElementById('busloc').value);if(++reportbus%2!=0)subbuslocate();}return b;" value="Submit"/>
				</form>
			</div>
